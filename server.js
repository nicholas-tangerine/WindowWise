...
app.post('/api/v1/submit', async (req, res) => {
    ...
    const dormParameters = getDormParameters(collegeToEnum(college), roomType);
    const result = await calculateTime(currentTemp, targetTemp, dormParameters.latitude, dormParameters.longitude, dormParameters.roomVolume, dormParameters.windowArea)
    console.log(result)
